...
Gem::Specification.new do |spec|
  ...
  spec.authors       = ["ODO: Write your name"]
  spec.email         = ["ODO: Write your email address"]

  spec.summary       = %q{ODO: Write a short summary, because Rubygems requires one.}
  spec.description   = %q{ODO: Write a longer description or delete this line.}
